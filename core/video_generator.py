...
Background: Pure WHITE (#FFFFFF) for entire duration
...
# 便捷函数
def generate_video_batch(image, actions: List[str], model_name: str, duration: int = 6, backend: str = "gemini", resolution: str = "720p", max_workers: int = 3):
    """便捷函数：批量生成动画视频"""
